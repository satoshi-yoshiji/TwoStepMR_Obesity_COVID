...
list=$(head -n ${PBS_ARRAYID} /scratch/richards/satoshi.yoshiji/11.pQTL/03.cispQTL_decode2021_sep_batch/listbatch.txt | tail -n 1)
for protein in `cat $list`;
do
protein_name=`basename $protein ".tsv"
`
