...
################
# BMI GWAS
# Donwloaded from https://portals.broadinstitute.org/ 
# Even though these SNPs are already conditionally independent, we took a conservative approach and performed a conventional clumping
################
